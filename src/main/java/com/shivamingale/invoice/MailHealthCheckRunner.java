...
import com.shivamingale.invoice.service.MailService;
...
public class MailHealthCheckRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            ...
            log.warn("Mail service health check failed: {}. Application will continue but email features may not work.", e.getMessage());
        }
    }
}
