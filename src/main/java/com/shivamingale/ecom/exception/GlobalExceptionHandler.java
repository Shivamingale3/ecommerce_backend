...
public class GlobalExceptionHandler {
        ...
        public AppResponse<Void> handleDataIntegrityViolation(DataIntegrityViolationException ex,
        ...
        public AppResponse<Void> handleMaxUploadSizeExceeded(MaxUploadSizeExceededException ex,
                        HttpServletRequest request) {
        ...
        public AppResponse<Void> handleIllegalArgumentException(IllegalArgumentException ex,
                        HttpServletRequest request) {
