...
public class GlobalExceptionHandler {
        ...
        public ResponseEntity<AppResponse<Void>> handleAppException(AppException ex, HttpServletRequest request) {
        ...
        public ResponseEntity<AppResponse<Void>> handleValidation(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        public ResponseEntity<AppResponse<Void>> handleBindException(BindException ex, HttpServletRequest request) {
        ...
        public ResponseEntity<AppResponse<Void>> handleDataIntegrityViolation(DataIntegrityViolationException ex,
        ...
        public ResponseEntity<AppResponse<Void>> handleMessagingException(MessagingException ex, HttpServletRequest request) {
        ...
        public ResponseEntity<AppResponse<Void>> handleS3Exception(SdkException ex, HttpServletRequest request) {
                String rootMessage = getRootCauseMessage(ex);
        ...
        public ResponseEntity<AppResponse<Void>> handleIOException(IOException ex, HttpServletRequest request) {
                String rootMessage = getRootCauseMessage(ex);
        ...
        public ResponseEntity<AppResponse<Void>> handleMaxUploadSizeExceeded(MaxUploadSizeExceededException ex,
                        HttpServletRequest request) {
        ...
        public ResponseEntity<AppResponse<Void>> handleNullPointerException(NullPointerException ex, HttpServletRequest request) {
                String rootMessage = getRootCauseMessage(ex);
        ...
        public ResponseEntity<AppResponse<Void>> handleGeneric(Exception ex, HttpServletRequest request) {
                String rootMessage = getRootCauseMessage(ex);

                log.error("Unhandled exception at {} [traceId={}]: {}", request.getRequestURI(), getTraceId(),
                                rootMessage, ex);
                return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                        .body(AppResponse.error(
        ...
        private String extractColumnFromConstraint(String constraintName) {
                ...
                if (constraintName.contains("_")) {
                        ...
                        for (int i = parts.length - 1; i >= 0; i--) {
                                ...
                                if (!part.equals("key") && !part.equals("idx") && !part.equals("fkey")
                                                && part.length() > 2) {
                                        return part;
                                }
                        }
