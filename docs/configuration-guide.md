...
logging:
  level:
    root: INFO
    com.shivamingale.invoice: DEBUG
...
logging:
  level:
    root: WARN
    com.shivamingale.invoice: INFO    # Application logs at INFO
...
```
2026-04-14 18:22:17.416 INFO  com.shivamingale.invoice.AuthService - User logged in: shivam@example.com
```
...
```json
{"timestamp":"2026-04-14T18:22:17.416+05:30","level":"INFO","logger":"com.shivamingale.invoice.service.AuthService","message":"User logged in: shivam@example.com","thread":"main","application":"invoice-platform"}
```
